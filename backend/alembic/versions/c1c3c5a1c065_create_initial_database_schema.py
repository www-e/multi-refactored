...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('voice', name='campaigntypeenum'), nullable=False),
    ...
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('tenant_id', sa.String(), nullable=False),
    sa.Column('channel', sa.Enum('voice', name='channelenum'), nullable=False),
    ...
    sa.Column('source', sa.Enum('voice', name='channelenum'), nullable=False),
